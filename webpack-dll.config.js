...
const dirVars = require('./conf/base/dir-vars.config.js'); // 与业务代码共用同一份路径的配置表
...
module.exports = {
  ...
  module: require('./conf/module.config.js'), // 沿用业务代码的module配置
  resolve: require('./conf/resolve.config.js'), // 沿用业务代码的resolve配置
};
